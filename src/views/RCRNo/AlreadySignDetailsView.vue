<template>
    <div id="AlreadySignDetailsView">
        <div class="top">
            <div class="title">
                <h2>成宜公司【安巡查】009</h2>
                <p @click="toNotSubmittedDetails"><</p>
            </div>
        </div>
        <div class="content">
        ...
        <div class="bottom">
            <div class="bottomContent">
                <button @click="toNotSubmittedDetails">返回</button>
            </div>
        </div>
    </div>
</template>
